...
public class CRC16Util {
	...
	/**
	 * 反转crc16的高低位,适用于Modbus的crc16校验(地位在前，高位在后)
	 * 
	 * @param orgin
	 *            原始crc16
	 * @return 高低位交换后的crc16
	 */
	public static int hiloReverseToInt(int orgin) {
		String s1 = String.format("%04x", orgin);
		String s2 = s1.substring(2, 4) + s1.substring(0, 2);
		return Integer.valueOf(s2, 16);
	}

	public static String hiloReverseToHexString(int orgin) {
		String s1 = String.format("%04x", orgin);
		String s2 = s1.substring(2, 4) + s1.substring(0, 2);
		return s2;
	}

	public static String crc16ToHexString(int orgin) {
		return String.format("%04x", orgin);
	}

	// 测试
	public static void main(String[] args) {
		// 0x01, 0x03, 0x00, 0x01, 0x00, 0x01 , crc16=CA D5
//		int crc = CRC16Util.calcCrc16(ModbusConstant.WriteCommand.WRITE_VOLTAGE_ELECTRICITY_BAUDRATE_TO_9600);
//		System.out.println(crc);
//		String s1 = String.format("%04x", crc);
//		System.out.println(s1);
//
//		int crcReverse = hiloReverseToInt(crc);
//		System.out.println(crcReverse);
//		System.out.println(hiloReverseToHexString(crc));

		// byte i = (byte)128;
		// System.out.println(Integer.toBinaryString(128));
		// System.out.println(i);
		
		byte[] command = CommandUtil.createReadCommand(ModbusConstant.WriteCommand.WRITE_VOLTAGE_ELECTRICITY_BAUDRATE_TO_9600);
